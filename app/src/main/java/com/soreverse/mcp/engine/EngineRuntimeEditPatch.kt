...
internal fun EngineRuntime.editHex(workspaceId: String, editSessionId: String, locator: String, edits: JSONArray, dryRun: Boolean = false): JSONObject =
    guarded {
        withSession(
            workspaceId,
            editSessionId,
...
internal fun EngineRuntime.editAsm(workspaceId: String, editSessionId: String, locator: String, edits: JSONArray, dryRun: Boolean = false): JSONObject =
    guarded {
        withSession(
            workspaceId,
            editSessionId,
...
internal fun EngineRuntime.editSymbol(workspaceId: String, editSessionId: String, locator: String, edits: JSONArray, dryRun: Boolean = false): JSONObject =
    guarded {
        withSession(
            workspaceId,
            editSessionId,
